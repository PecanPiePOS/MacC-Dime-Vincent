//
//  ArtItemCollectionViewcellController.swift
//  Vincent
//
...
final class ArtItemCell: UICollectionViewCell {
    ...
    func setup(with artitem: ArtItem) {
...
extension ArtItemCell: ReusableView {
